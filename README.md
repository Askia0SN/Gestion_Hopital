...
http://localhost/Projet_gestion_Hopital/
...
verification en DB avec PDO;
password_verify compare le mot de passe;
stockage de user_id et user_name en session;
...
Modifier chaque element.
Supprimer un patient et verifier la suppression cascade.
Se deconnecter.
Resultat attendu:
